...
gihandle1 OSCinit 7770 ; red pod
gihandle2 OSCinit 7771 ; blue pod
...
nxtmsg:
 	...
 	kk OSClisten gihandle1, "/eeg", "iiiiiiii", kf1, kf2, kf3, kf4, kf5, kf6, kf7, kf8
...
nxtmsg:
 	...
 	kk OSClisten gihandle2, "/eeg", "iiiiiiii", kf1, kf2, kf3, kf4, kf5, kf6, kf7, kf8
...
;these two
;i1 0    3000  46     1    1  .0411229     .1
;i1 .2   3000   138  .7   1   .1013524     .2  


;              freq        scale ifn idelbase   pan
i1 0    3000     46         1    1   1        .5   ;red
i2 .39  3000     174.6     .8    1   1        .5  ;blue


;these two
;i2 .8  3000     36         .7   1  .01   .9  
;i2 .39 3000     239.4432   .5   1   .002  1
