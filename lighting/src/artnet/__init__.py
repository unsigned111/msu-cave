...
OPCODES = dict(
    ...
    # This is an ArtDmx data packet. It contains zero start code DMX512 information for a single Universe.
    OpDmx=0x0050,
    # This is an ArtNzs data packet. It contains non-zero start code (except RDM)
    # DMX512 information for a single Universe.
    OpNzs=0x0051,
    ...
    OpRdmSub=0x0084,
    # This is an ArtVideoSetup packet. It contains video screen setup information for
    # nodes that implement the extended video features.
    OpVideoSetup=0x10a0,
    # This is an ArtVideoPalette packet. It contains colour palette setup information
    # for nodes that implement the extended video features.
    OpVideoPalette=0x20a0,
    # This is an ArtVideoData packet. It contains display data for nodes that implement
    # the extended video features.
    OpVideoData=0x40a0,
    # This is an ArtMacMaster packet. It is used to program the Node's MAC address,
    # Oem device type and ESTA manufacturer code.
    # This is for factory initialisation of a Node. It is not to be used by applications.
    OpMacMaster=0x00f0,
    # This is an ArtMacSlave packet. It is returned by the node to acknowledge receipt
    # of an ArtMacMaster packet.
    OpMacSlave=0x00f1,
    # This is an ArtFirmwareMaster packet. It is used to upload new firmware or
    # firmware extensions to the Node.
    OpFirmwareMaster=0x00f2,
    # This is an ArtFirmwareReply packet. It is returned by the node to acknowledge
    # receipt of an ArtFirmwareMaster packet or ArtFileTnMaster packet.
    ...
    # This is an ArtIpProg packet. It is used to reprogramme the IP,Mask and Port
    # address of the Node.
    OpIpProg=0x00f8,
    # This is an ArtIpProgReply packet. It is returned by the node to acknowledge
    # receipt of an ArtIpProg packet.
    OpIpProgReply=0x00f9,
    # This is an ArtMedia packet. It is Unicast by a Media Server and acted upon
    # by a Controller.
    OpMedia=0x0090,
    # This is an ArtMediaPatch packet. It is Unicast by a Controller and acted
    # upon by a Media Server.
    OpMediaPatch=0x0091,
    # This is an ArtMediaControl packet. It is Unicast by a Controller and acted
    # upon by a Media Server.
    OpMediaControl=0x0092,
    # This is an ArtMediaControlReply packet. It is Unicast by a Media Server and
    # acted upon by a Controller.
